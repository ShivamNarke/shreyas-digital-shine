          ...
          <div className="space-y-8 text-muted-foreground animate-slide-up">
            ...
            <section className="space-y-4">
              ...
              <div className="bg-card p-6 rounded-lg border border-border">
                <p><strong>Email:</strong> shreyasenterprises99@gmail.com</p>
                <p><strong>Phone:</strong> +91 9923269825</p>
                <p><strong>Address:</strong> Shreyas Enterprises, [Donawade Fata]</p>
              </div>
            </section>
